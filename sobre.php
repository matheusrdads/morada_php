      ...
      <div class="carousel-item active">
        ...
        <div class="container bg-text ">
          <h3 class="display-3 text-about">NOSSA MISSÃO</h1>
            <h3>
              <small>
                Somos uma organização que visa o desenvolvimento individual
                e coletivo de pessoas em situação insustentável de moradia.
                Neste processo estamos dispostos a melhorar moradias em situação de risco,
        ...
        <div class="container bg-text ">
          ...
          <h3>
            <small>
              ...
              entra em contato para prover uma mudança
              na realidade de seu próximo, seja com doações de materias,
              ferramentas, mão de obra ou trasporte de materias.
            </small>
          </h3>
        </div>
      </div>
